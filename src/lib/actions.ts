...
import type { QuizGenerationInput, QuizGenerationOutput } from "@/lib/types";

// In a real app, this data would come from a database of learned signs.
const sampleSigns: QuizGenerationInput["signs"] = [
...
export async function getQuizAction(): Promise<QuizGenerationOutput | null> {
  try {
